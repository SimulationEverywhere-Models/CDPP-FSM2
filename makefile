...
LDFLAGS+=-L. -g
#^|
EXAMPLESOBJS=  moorestate.o register.o queue.o main.o generat.o cpu.o transduc.o distri.o com.o linpack.o debug.o trafico.o
#!
...
#^|
moorestate.o: /cygdrive/C/eclipse/workspace/moore/moorestate.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
register.o: /cygdrive/C/eclipse/workspace/moore/register.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
#
...
#^|
moorestate.o: /cygdrive/C/eclipse/workspace/moore/moorestate.cpp \
 /cygdrive/C/eclipse/workspace/moore/moorestate.h \
